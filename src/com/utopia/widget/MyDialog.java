...
public class MyDialog extends Dialog implements
	...
	private static MyDialog mBaseDialog;// 当前的对话框
	...
	private void initViews() {
		...
		mHtvTitle = (MyTextView) findViewById(R.id.dialog_generic_htv_title);
		...
		mHtvMessage = (MyTextView) findViewById(R.id.dialog_generic_htv_message);
	...
	public static MyDialog getDialog(Context context, CharSequence title,
	...
	public static MyDialog getDialog(Context context, CharSequence title,
		...
		mBaseDialog = new MyDialog(context);
