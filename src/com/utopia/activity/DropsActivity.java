...
public class DropsActivity extends BaseActivity implements OnClickListener {
	...
	public void onClick(View view) {
		...
		case R.id.et_OK:
			...
			// a
			dropsMoney = editText.getText().toString();

			if (dropsMoney.equals("")) {
	...
	private class RefreshAsyncTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			return new JsonResolveUtils(DropsActivity.this)
	...
	private boolean insert() {
		localCashier.setChangeMoney(Float.parseFloat(dropsMoney));
	...
	protected void initViews() {
		editText = (TextView) findViewById(R.id.drop_Money);
	}
