...
public class sql_Test {
	...
	public String getNumber() {
		...
		String sql[] = { "select count(*) from Product",
				...
				"select count(*) from Menutype", "select count(*) from Tax",
				"select count(*) from Salerecord", "select count(*) from Bill",
				"select count(*) from Cashier", "select count(*) from Contact",
				"select count(*) from saleandpdt"
